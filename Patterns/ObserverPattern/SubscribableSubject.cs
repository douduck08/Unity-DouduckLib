...
namespace DouduckGame {
    public class SubscribableSubject {

        protected List<SubscribableObserver> m_Observers = new List<SubscribableObserver> ();
        ...
        public virtual SubscribableObserver RegisterObserver (int iEventId, Action<int> observerCallback) {
            AddCallback (iEventId, observerCallback);
            SubscribableObserver newObserver_ = new SubscribableObserver (iEventId, observerCallback);
